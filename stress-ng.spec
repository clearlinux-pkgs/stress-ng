...
Version  : 0.18.10
Release  : 178
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.18.10/stress-ng-0.18.10.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.18.10/stress-ng-0.18.10.tar.gz
...
%prep
%setup -q -n stress-ng-0.18.10
cd %{_builddir}/stress-ng-0.18.10
pushd ..
cp -a stress-ng-0.18.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738597368
