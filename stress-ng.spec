...
Version  : 0.13.09
Release  : 114
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.13.09/stress-ng-0.13.09.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.13.09/stress-ng-0.13.09.tar.gz
...
%prep
%setup -q -n stress-ng-0.13.09
cd %{_builddir}/stress-ng-0.13.09
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640046646
...
cp %{_builddir}/stress-ng-0.13.09/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
