...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.15.03/stress-ng-0.15.03.tar.gz
...
%prep
%setup -q -n stress-ng-0.15.03
cd %{_builddir}/stress-ng-0.15.03
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674134031
