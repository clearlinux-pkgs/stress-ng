...
Version  : 0.13.08
Release  : 113
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.13.08/stress-ng-0.13.08.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.13.08/stress-ng-0.13.08.tar.gz
...
%prep
%setup -q -n stress-ng-0.13.08
cd %{_builddir}/stress-ng-0.13.08
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638893662
...
cp %{_builddir}/stress-ng-0.13.08/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
