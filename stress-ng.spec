...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.16.01/stress-ng-0.16.01.tar.gz
...
%prep
%setup -q -n stress-ng-0.16.01
cd %{_builddir}/stress-ng-0.16.01
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689073466
