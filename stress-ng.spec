...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.10.09/stress-ng-0.10.09.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573019765
...
cp %{_builddir}/stress-ng-0.10.09/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/stress-ng-0.10.09/debian/copyright %{buildroot}/usr/share/package-licenses/stress-ng/56a9001fce0a93a522a994e6cf80ba1419bed107
%make_install
