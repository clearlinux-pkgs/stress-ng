...
Version  : 0.09.48
Release  : 29
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.09.48.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.09.48.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1543734558
make  %{?_smp_mflags}
