...
Version  : 0.13.07
Release  : 112
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.13.07/stress-ng-0.13.07.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.13.07/stress-ng-0.13.07.tar.gz
...
%prep
%setup -q -n stress-ng-0.13.07
cd %{_builddir}/stress-ng-0.13.07
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637169136
...
cp %{_builddir}/stress-ng-0.13.07/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
