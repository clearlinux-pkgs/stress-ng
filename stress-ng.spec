...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.18.00/stress-ng-0.18.00.tar.gz
...
%prep
%setup -q -n stress-ng-0.18.00
cd %{_builddir}/stress-ng-0.18.00
pushd ..
cp -a stress-ng-0.18.00 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717723179
