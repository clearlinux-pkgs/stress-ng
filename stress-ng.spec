...
Version  : 0.17.05
Release  : 161
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.17.05/stress-ng-0.17.05.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.17.05/stress-ng-0.17.05.tar.gz
...
%prep
%setup -q -n stress-ng-0.17.05
cd %{_builddir}/stress-ng-0.17.05
pushd ..
cp -a stress-ng-0.17.05 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706886978
