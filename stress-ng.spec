...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.13.00/stress-ng-0.13.00.tar.gz
...
%prep
%setup -q -n stress-ng-0.13.00
cd %{_builddir}/stress-ng-0.13.00
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628006154
...
cp %{_builddir}/stress-ng-0.13.00/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/stress-ng-0.13.00/debian/copyright %{buildroot}/usr/share/package-licenses/stress-ng/3c1b026a6045c9f416c4343ea2a973e607139a6f
%make_install
