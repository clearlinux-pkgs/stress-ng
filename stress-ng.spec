...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.15.02/stress-ng-0.15.02.tar.gz
...
%prep
%setup -q -n stress-ng-0.15.02
cd %{_builddir}/stress-ng-0.15.02
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673547542
