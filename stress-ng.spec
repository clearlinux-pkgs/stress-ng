...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.17.06/stress-ng-0.17.06.tar.gz
...
%prep
%setup -q -n stress-ng-0.17.06
cd %{_builddir}/stress-ng-0.17.06
pushd ..
cp -a stress-ng-0.17.06 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709661144
