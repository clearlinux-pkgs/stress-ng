...
Version  : 0.17.07
Release  : 164
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.17.07/stress-ng-0.17.07.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.17.07/stress-ng-0.17.07.tar.gz
...
%prep
%setup -q -n stress-ng-0.17.07
cd %{_builddir}/stress-ng-0.17.07
pushd ..
cp -a stress-ng-0.17.07 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712269158
