...
Version  : 0.10.15
Release  : 61
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.10.15/stress-ng-0.10.15.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.10.15/stress-ng-0.10.15.tar.gz
...
%prep
%setup -q -n stress-ng-0.10.15
cd %{_builddir}/stress-ng-0.10.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578160289
...
cp %{_builddir}/stress-ng-0.10.15/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/stress-ng-0.10.15/debian/copyright %{buildroot}/usr/share/package-licenses/stress-ng/56a9001fce0a93a522a994e6cf80ba1419bed107
%make_install
