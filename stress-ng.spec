...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.13.10/stress-ng-0.13.10.tar.gz
...
%prep
%setup -q -n stress-ng-0.13.10
cd %{_builddir}/stress-ng-0.13.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641403751
...
cp %{_builddir}/stress-ng-0.13.10/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
