...
Version  : 0.10.18
Release  : 64
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.10.18/stress-ng-0.10.18.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.10.18/stress-ng-0.10.18.tar.gz
...
%prep
%setup -q -n stress-ng-0.10.18
cd %{_builddir}/stress-ng-0.10.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580321201
...
cp %{_builddir}/stress-ng-0.10.18/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
