...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.18.09/stress-ng-0.18.09.tar.gz
...
%prep
%setup -q -n stress-ng-0.18.09
cd %{_builddir}/stress-ng-0.18.09
pushd ..
cp -a stress-ng-0.18.09 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736176297
