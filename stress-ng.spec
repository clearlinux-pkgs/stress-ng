...
Version  : 0.14.03
Release  : 121
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.14.03/stress-ng-0.14.03.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.14.03/stress-ng-0.14.03.tar.gz
...
%prep
%setup -q -n stress-ng-0.14.03
cd %{_builddir}/stress-ng-0.14.03
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658418142
...
cp %{_builddir}/stress-ng-0.14.03/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
