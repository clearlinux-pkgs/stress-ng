...
Version  : 0.18.01
Release  : 168
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.18.01/stress-ng-0.18.01.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.18.01/stress-ng-0.18.01.tar.gz
...
%prep
%setup -q -n stress-ng-0.18.01
cd %{_builddir}/stress-ng-0.18.01
pushd ..
cp -a stress-ng-0.18.01 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720113639
