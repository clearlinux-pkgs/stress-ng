...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.10.19/stress-ng-0.10.19.tar.gz
...
%prep
%setup -q -n stress-ng-0.10.19
cd %{_builddir}/stress-ng-0.10.19
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581092220
...
cp %{_builddir}/stress-ng-0.10.19/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
