...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.13.06/stress-ng-0.13.06.tar.gz
...
%prep
%setup -q -n stress-ng-0.13.06
cd %{_builddir}/stress-ng-0.13.06
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635434627
...
cp %{_builddir}/stress-ng-0.13.06/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
