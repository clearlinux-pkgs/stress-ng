...
Version  : 0.18.02
Release  : 169
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.18.02/stress-ng-0.18.02.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.18.02/stress-ng-0.18.02.tar.gz
...
%prep
%setup -q -n stress-ng-0.18.02
cd %{_builddir}/stress-ng-0.18.02
pushd ..
cp -a stress-ng-0.18.02 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722447917
