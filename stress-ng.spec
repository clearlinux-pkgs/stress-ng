...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.11.15/stress-ng-0.11.15.tar.gz
...
%prep
%setup -q -n stress-ng-0.11.15
cd %{_builddir}/stress-ng-0.11.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594685523
...
cp %{_builddir}/stress-ng-0.11.15/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/stress-ng-0.11.15/debian/copyright %{buildroot}/usr/share/package-licenses/stress-ng/646bc3322590665b5d3306b585db045fbef06318
%make_install
