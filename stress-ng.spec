...
Version  : 0.13.11
Release  : 116
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.13.11/stress-ng-0.13.11.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.13.11/stress-ng-0.13.11.tar.gz
...
%prep
%setup -q -n stress-ng-0.13.11
cd %{_builddir}/stress-ng-0.13.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643586290
...
cp %{_builddir}/stress-ng-0.13.11/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
