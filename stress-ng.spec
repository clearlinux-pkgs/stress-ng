...
Version  : 0.12.02
Release  : 93
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.12.02/stress-ng-0.12.02.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.12.02/stress-ng-0.12.02.tar.gz
...
%prep
%setup -q -n stress-ng-0.12.02
cd %{_builddir}/stress-ng-0.12.02
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611430561
...
cp %{_builddir}/stress-ng-0.12.02/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
