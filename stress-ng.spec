...
Version  : 0.10.17
Release  : 63
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.10.17/stress-ng-0.10.17.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.10.17/stress-ng-0.10.17.tar.gz
...
%prep
%setup -q -n stress-ng-0.10.17
cd %{_builddir}/stress-ng-0.10.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580237618
...
cp %{_builddir}/stress-ng-0.10.17/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
