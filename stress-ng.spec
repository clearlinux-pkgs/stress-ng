...
Version  : 0.09.36
Release  : 20
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.09.36.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.09.36.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533228377
make  %{?_smp_mflags}
