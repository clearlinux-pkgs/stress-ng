...
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.18.12/stress-ng-0.18.12.tar.gz
...
%prep
%setup -q -n stress-ng-0.18.12
cd %{_builddir}/stress-ng-0.18.12
%patch -P 1 -p1
pushd ..
cp -a stress-ng-0.18.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743433723
