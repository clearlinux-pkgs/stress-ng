...
Version  : 0.10.16
Release  : 62
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.10.16/stress-ng-0.10.16.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.10.16/stress-ng-0.10.16.tar.gz
...
%prep
%setup -q -n stress-ng-0.10.16
cd %{_builddir}/stress-ng-0.10.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578697750
...
cp %{_builddir}/stress-ng-0.10.16/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
