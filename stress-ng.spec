...
Version  : 0.19.00
Release  : 180
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.19.00/stress-ng-0.19.00.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.19.00/stress-ng-0.19.00.tar.gz
...
%prep
%setup -q -n stress-ng-0.19.00
cd %{_builddir}/stress-ng-0.19.00
%patch -P 1 -p1
pushd ..
cp -a stress-ng-0.19.00 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746108634
