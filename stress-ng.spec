...
Version  : 0.14.01
Release  : 119
URL      : https://github.com/ColinIanKing/stress-ng/archive/V0.14.01/stress-ng-0.14.01.tar.gz
Source0  : https://github.com/ColinIanKing/stress-ng/archive/V0.14.01/stress-ng-0.14.01.tar.gz
...
%prep
%setup -q -n stress-ng-0.14.01
cd %{_builddir}/stress-ng-0.14.01
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651798599
...
cp %{_builddir}/stress-ng-0.14.01/COPYING %{buildroot}/usr/share/package-licenses/stress-ng/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
